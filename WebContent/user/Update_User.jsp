        ...
        <div class="mypresent">
            ...
            <dl>
	                <dt>H.Point Plus 포인트</dt>
	                    <dd><a nohref id="btnHeaderUmbSwitcJoin2">통합회원 전환</a></dd>
	                </dl>
            <dl>
	                <dt>구매금액</dt>
...
function openDRMOKWindow(type,goodsCd,qty,buynow,setGoosId, cartSeq , cartSetId, notAdtGoodsCd , notAdtQtyList){
    ...
    window.name = 'sendJsp';
    DRMOK_window = window.open(url+'?cpid=hddfs&rtn_url=http://www.hddfs.com/shop/mm/mbshAuca/adultAuca.do?goosInfo='+goosInfo+'&req_info=WuFFZIoyK0IzFELueNDPmpWLt36NtZwQKNRpzB6ce9ZJE%2FcbHPZNPUMZDt2qiJreDsROo%2B1%2Ftls%2FxYXF7KM41csxHeCTTwaNH8fMAkMYEOXQfQYFHM0sSS0c84C7fWUINNFrAenNFX1jE82OrluC2j8qdELTeD9R17FET%2BXytlZ0W6F75UWnzk0qXKfi1F8Qe8Bgsusj9G%2Bkp6xJBVHnFUB9nzI%2BHA6rBCh22Y%2BhyBP7cIEBSLI3q9pJwfYrjUalLAsUK0JN7O6kBcTDxOdAzyDxRnzUGJgvSh5ErDcUk01zDlkiHnFhby1nLBG44wjOFEjHHYkZHGZKTj%2BrcZgN1w%3D%3D', 'DRMOKWindow', 'width=425,height=550,scrollbars=no,toolbar=no,location=no,directories=no,status=no' );
    DRMOK_window.focus();
