...
$(function(){
	...
	<section class="myhd_content">
	    <div class="tab-style">
	        <ul class="tab_1depth">
	            <li class="ui-tabs-active" id="onlnOrder" onclick="fn_changeOnlnOfln('onln');">
	                <a>온라인 주문내역</a>
	            </li>
	            <li id="oflnOrder" onclick="fn_changeOnlnOfln('ofln');">
	                <a>오프라인 주문내역</a>
	            </li>
	        </ul>
	    </div>
	    <div class="tab-action">
	        <ul class="tab_2depth tab_center">
	            ...
	            <li class="ui-tab" id="tabCtgOrderType" value="order">
	                <a onclick="fn_search('order');" href="#date_order">주문일 기준</a>
	            </li>
	        </ul>
	 ...
	 <div class="period">
          <div class="period_cover">
              <ul class="textbox monthbox">
                  <li><a nohref onclick="fnDateSetting(this,'1');" id="dtSrchFirstTab" >1개월</a></li>
              ...
              <div class="datebox">
                  <span class="datepicker_box">
                      <input type="text" id="stDt" name="stDt" onkeyup="isNumber(this);" class="datepicker" value="" maxlength="10" placeholder="0000-00-00">
                  </span>
                  <span class="from">~</span>
                  <span class="datepicker_box">
                      <input type="text" id="endDt" name="endDt" onkeyup="isNumber(this);" class="datepicker" value="" maxlength="10" placeholder="0000-00-00">
                  </span>
              </div>
              <button type="button" class="btnde_type1 mid dcheck_btn" onclick="fnValidation();">조회</button>
          </div>
      </div>
...
<div id="my_order">	
            			...
            			<div id="dpatDiv" >
            				<div id="date_departure">
		            			<div class="sorting_wrap myhd"">
		               				<span class="txt_total">총 <strong>0</strong>개</span>
		                			<div class="sort_r">
		        ...
		        <div class="cart_list" id="ofln_list">	
           			<div id="oflnDpatDiv" >
           				<div id="date_departure">
	            			<div class="sorting_wrap myhd"">
	               				<span class="txt_total">총 <strong>0</strong>개</span>
	                			<div class="sort_r">
	                			    <select name="billStat" id="billStat2" >
	                                    <option value="" >전체</option>
	                                    <option value="010" >입금대기</option>
	                                    <option value="020" >주문완료</option>
	                                    <option value="030^040" >상품준비중</option>
	                                    ...
	                                    <option value="080" >취소신청</option>
	                                    <option value="070" >반품신청</option>
	                                    <option value="07" >반입 면장 확정</option>
	                                    <option value="100" >취소완료</option>
	                                </select>
	                			</div>
           					</div>
                           <div class="list_table01 offline_order01">
                                <table>
                                    <colgroup>
                                        <col width="95px">
                                        <col width="95px">
	                ...
	                <div id="oflnOrderDiv" >
           				<div id="date_departure">
	            			<div class="sorting_wrap myhd"">
	               				<span class="txt_total">총 <strong>0</strong>개</span>
	                			<div class="sort_r">
	                			<select name="orderStat" id="orderStat2" >
	                                    <option value="" >전체</option>
	                                    <option value="010" >입금대기</option>
	                                    <option value="020" >주문완료</option>
	                                    <option value="030^040" >상품준비중</option>
                           ...
                           <div class="list_table01 offline_order02">
                                <table>
                                    <colgroup>
                                        <col width="95px">
                                        <col width="95px">
...
&bull;&nbsp;화장품/식품等 유통기한과 연관있는 상품의 경우 출국정보 변경 시 유통기한이 임박 또는 초과된 상품을 받을 수 있으므로 유의하시기 바랍니다.<br />
