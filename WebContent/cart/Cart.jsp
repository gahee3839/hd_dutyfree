...
<section class="cart_wrap">
  ...
  <div class="cart_contens">
       <div class="cont_left" id="CART">
           <input type="hidden" id="cartListLength" value="1"/>
...
<div class="cart_list">
    <input type="hidden" id="spordYn0" name="spordYn"  value="N"/>
                ...
                <input type="hidden" id="goosKrw0" value='200762' />
                <input type="hidden" id="DcUsd0" value='66.5999984741211' />
                <input type="hidden" id="DcKrw0" value='90343' />
                <input type="hidden" id="settUsd0" value='81.4000015258789' />
                <input type="hidden" id="settKrw0" value='110419' />
                ...
                <input type="hidden" id="finaPmptDcCupDcAmt0" value='0' /> <input type="hidden" id="rsvgDcKrw0" value='0' />        <input type="hidden" id="hpoinRsvgAmt0" value='221.0' />    <input type="hidden" id="hpoinRsvgRate0" value='0.2' />  <input type="hidden" id="simpRsvgAmt0" value='0.0' />      <input type="hidden" id="simpRsvgRate0" value='0.0' />    <input type="hidden" id="oldGoosSeq0" value=''/>  
                <input type="hidden" id="orderMinQty0" value='1'/> <div class="item_area">
                            <div class="item_chk">
                                <span class="chk nolabel">
                                    <input type="checkbox" name="cartSeq" id="cart_ch0" value="439241704" onclick="setuSettAmt('0','cartGoos');" class="cartSeqs" data-onlnGoosCd ="10073250016301"  data-idx="0"  checked>
                                    <label for="cart_ch0">선택</label>
                                </span>
                                <div class="btn_area">
                                    <button class="btn_onoff btn_pin"  onclick="mergeCnrRetn('439241704','10073250016301',this)">핀</button>
                                            ...
                                            <button class="btn_onoff btn_del" onclick="deleteCart(439241704, 'N', '0','','N');">삭제</button>
                                        </div>
                            </div>
                                ...
                                <div class="item_buy_wrap">
                                    <div class="item_buy">
                                        <div class="num_amount cart_amount">
                                            <input value="-"  type="button" disabled="disabled" id="minGoosQty0" onclick="changeGoosQty(439241704,'0','m',this', false);">
                                                    <input type="text" class="count" id="count0" value="1" min="0" name="goosQty" maxlength="5"  onkeyup="isNumber(this);" onfocusout="changeGoosQty(439241704,'0','c',this, false);">                                          
                                                
                                                <input value="+"  type="button" onclick="changeGoosQty(439241704,'0','p',this, false);">
                                                    </div>
                                        <button type="button" class="btnde_type1 large" onclick="goOrder(439241704);"><span class="font_14b">바로구매</span></button> 
                                    </div>
                                </div>                                     
                            </div>                              
                        </div>
...
<div class="attention_area">
	    ...
	    <div class="attention_list">
	        &bull; 장바구니에 담긴 상품은 30일간 보관됩니다.(장기간 보관을 원하실 경우 관심상품으로 등록(180일간 저장)하여 이용하시길 바랍니다.)<br />
&bull; 환율 변경 시점과 적립금의 사용조건에 따라 장바구니의 예상결제금액과 최종결제금액은 상이할 수 있습니다.<br />
&bull; 실제 할인금액은 개인별로 보유하신 적립금에 따라 차이가 있을 수 있습니다.<br />
&bull; 장바구니에 보관된 상품은 재고품절 및 할인율, 사은품이 수시로 변경될 수 있습니다.<br />
&bull; 주문 전 기내반입제한 안내를 확인하시기 바랍니다.<br />
&bull; 상품별로 한 주문번호당 주문 가능 수량이 제한될 수 있습니다.<br />
&bull; 세트상품은 함께 사면 할인 혜택을 받을 수 있는 상품이며, 주문 후 매장에 따라 교환권이 각기 다르게 발급될 수 있습니다.
	    </div>
	</div>          
           ...
           <div class="pay_table">
                   ...
                   <div class="pay_list">
                       ...
                       <dl>
                           <dt>예상할인금액</dt>
                           <dd>
                               <strong class="sale totalDcUsd">$0</strong>
                               <span class="sale totalDcKrw">0원</span>
                           </dd>
                       </dl>
                       <dl id="totalRsvgDcKrwDl" style=" display:  none;">
                                 <dt>적립금</dt>
                                 <dd>
                                     <strong class="totalRsvgDcKrw">원</strong>
                                     <span class="totalRsvg">
                                         .0%
                                             </span>
                                 </dd>
                             </dl>
                           <dl>
                                   <dt>H.Point</dt>
                                   <dd>
                                        <strong class="totalHpoinRsvgAmt">P</strong>
                                        <span class="totalhpoinRsvgRat">%</span>
                                   </dd>
                                </dl>                           
                            <input type="hidden" id="totalDcUsd" value="0" />
                                        <input type="hidden" id="totalDcKrw" value="0" />
                                        ...
                                        <input type="hidden" id="totalGoosUsd" value="0"/>
                                        <input type="hidden" id="totalGoosKrw" value="0"/>
                                        
                                        <input type="hidden" id="totalRsvgDcKrw" value=""/>
                                        <input type="hidden" id="totalHpoinRsvgAmt" value=""/>
                                        <input type="hidden" id="hpoinRsvgRate" value=""/>
                                        <input type="hidden" id="totalSimpRsvgAmt" value=""/>
                                        <input type="hidden" id="simpRsvgRate" value=""/>
                                       
                                        <input type="hidden" id="totalExptSettAmtUsd" value="0">  <input type="hidden" id="totalExptSettAmtKrw" value="0">  <input type="hidden" id="totalExptSettGoosQty" value="0" />  <input type="hidden" id="notTotalExptSettAmtUsd" value=""/> <input type="hidden" id="notTotalExptSettAmtKrw" value=""/>  <input type="hidden" id="notTotalExptSettGoosQty" value=""/>  <input type="hidden" id="oldsumGoosQty" value="">
                                         <input type="hidden" id="sumGoosQty" value=""/>
                                         <input type="hidden" id="totalSettUsd" value="0"/>
                                         <input type="hidden" id="totalSettKrw" value="0"/>
                                    <dl class="total_pay">
                           <dt>총 <strong class="sumGoosQty"></strong>개</dt>
                           <dd>
                               <strong class="payTotalSettUsd">$0</strong>
                               <span class="payTotalSettKrw">0원</span>
                           </dd>
                       </dl>
                   </div>
                   <div class="pay_btm">
...
function openDRMOKWindow(type,goodsCd,qty,buynow,setGoosId, cartSeq , cartSetId, notAdtGoodsCd , notAdtQtyList){
    ...
    window.name = 'sendJsp';
    DRMOK_window = window.open(url+'?cpid=hddfs&rtn_url=http://www.hddfs.com/shop/mm/mbshAuca/adultAuca.do?goosInfo='+goosInfo+'&req_info=eDkCfnMG%2F0AoAfd2y5KlW7R%2FZXz4w%2BnYmH58R3FyQ%2FZr%2FQ3oi%2FXWI6XIUclqtGXh7CgMDWP3DIDyZ2QYpcDD4LPIOne4ZETVcokh3ZsYV6EzEgRrQjwAx5xcjnMaxWozbUhnWINHKiG06EMynW%2BD5McClOEfs6uxnrX%2BYtExmYCS95oi%2BO%2FxHWsAR3N5kdW4V2aUnbqy1N3cqEOmfS4sRhGNnLEmtKtWruh8MBSKdomjwP8GrZWzfl39OHR0rTX%2Fg0OEen06mx63eKqt%2BW9DbyLdm07v6tED3zsZ93QPCKYdkOFcb4U%2FtLn8TXTVBeB0SCtZseAH%2BToFHkrL6i97wA%3D%3D', 'DRMOKWindow', 'width=425,height=550,scrollbars=no,toolbar=no,location=no,directories=no,status=no' );
    DRMOK_window.focus();
...
<div id="changeSetGoosQtyList"></div>
       ...
       <div class="cont_right">
           <div class="login_box">
                   <p>
                       로그인 하시면, 적립금 및 쿠폰등<br>다양한 혜택을 받으실 수 있습니다.
                   </p>
                   <a href="javascript:void(0);" class="btnde_type1 large" onclick="login('https://www.hddfs.com/shop/or/order/listCart.do');"><strong>로그인</strong></a>
               </div>
           </div>
       </div>       
    </div>
...
function openDRMOKWindow(type,goodsCd,qty,buynow,setGoosId, cartSeq , cartSetId, notAdtGoodsCd , notAdtQtyList){
    ...
    window.name = 'sendJsp';
    DRMOK_window = window.open(url+'?cpid=hddfs&rtn_url=http://www.hddfs.com/shop/mm/mbshAuca/adultAuca.do?goosInfo='+goosInfo+'&req_info=W7DB0Y0CYDaZWptU4CTI6LlH21XhK2wA%2BoimKqVow6azL69FWfRB%2B%2FHw7HSgYPp9sfA1zeCdXl%2FOtl63iNDdo6k%2Be%2B%2BZoJKZLGqim2MdSq05f4dHU6xN184hvQCYiqi9QxwtDOjszU3apFRkUONXwPygKWcgBnvIfNFy8JXsVvOLgCWqSQG%2BgA63iZR0oAT%2FOBeME2ONRgKA%2B7HF9x5bnifm4V1PrrU3r8CyNLdwyZ83Jv9q4QwMwZrIlEZZLFrsizlsr7Nu8oB5Qt601PfXSipmBbXV4vYQwJhxjuHcs65IknGyq4WWTWJW7V6bjb5ifkKOCeLH0iF%2FjZHNmad2kg%3D%3D', 'DRMOKWindow', 'width=425,height=550,scrollbars=no,toolbar=no,location=no,directories=no,status=no' );
    DRMOK_window.focus();
